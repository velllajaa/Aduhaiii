...
import { exportStateToJson, importStateFromJson, generateSampleData, INITIAL_STATE } from '../utils/storage';
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-rose-950/20 rounded-2xl border border-rose-900/30">
            <div>
              ...
              <p className="text-[11px] text-rose-400/70">Wipe all local records back to clean empty state.</p>
            </div>
            <button
