...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
  ...
  for (const m of activeMembers) {
    ...
    const lvl = log?.activityLevel || 'under_1h';
    const effectiveLvl: ActivityLevel = (lvl as string) === 'loa' ? 'exempted' : lvl;
    currentDayStats[effectiveLvl] = (currentDayStats[effectiveLvl] || 0) + 1;
  }
